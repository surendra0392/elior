...
@push('meta')
    @php
        $categoryTitle = trim($category->meta_title) != '' ? $category->meta_title : $category->name . ' | ELIOR';
...
<x-shop::layouts>
    ...
    @if (core()->getConfigData('general.general.breadcrumbs.shop'))
        ...
        <div class="site-container pt-4 pb-2 sm:pt-6 sm:pb-3">
            <nav aria-label="Breadcrumb" class="flex items-center space-x-2 text-[11px] sm:text-xs uppercase tracking-[0.14em] text-elior-muted">
                ...
                <span class="text-elior-charcoal font-semibold">{{ $category->name }}</span>
            </nav>
        </div>
    @endif
    ...
    @if ($category->banner_path)
        <div class="site-container mt-4 sm:mt-6">
    ...
    @if (in_array($category->display_mode, [null, 'description_only', 'products_and_description']))
        <section class="site-container pt-6 pb-8 sm:pt-10 sm:pb-12 text-center max-w-3xl mx-auto space-y-4">
            <h1 class="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-elior-charcoal leading-tight">
                {{ $category->name }}
            </h1>
            @if ($category->description)
                <div class="text-sm sm:text-base text-elior-muted leading-relaxed mx-auto max-w-2xl">
    ...
    @pushOnce('scripts')
        ...
        >
            <div class="site-container pb-16 sm:pb-24">
