...
@component('shop::emails.layout')
    ...
    >
        <tr>
            <td style="padding: 8px 12px 8px 0;font-size: 14px;font-weight: 600;color: #163923;width: 180px;vertical-align: top;white-space: nowrap;">
                @lang('shop::app.eu_withdrawal.emails.confirmation.reference')
            </td>

            <td style="padding: 8px 0;font-size: 14px;color: #205132;font-family: 'Courier New', monospace;">
                {{ $withdrawal->uuid }}
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="padding: 8px 0;font-size: 14px;color: #205132;">
    ...
    <p style="font-size: 16px;color: #205132;line-height: 24px;margin-bottom: 24px;">
