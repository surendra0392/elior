        ...
        $this->addColumn([
            ...
            'closure' => function ($row) {
                ...
                if (
                    ...
                    return '<div class="flex flex-col gap-1"><p class="label-pending">'.trans('admin::app.sales.invoices.index.datagrid.pending').'</p><p class="block text-xs italic leading-5 text-rose-600">'.$extra.'</p></div>';
                }
                ...
                if ($row->state == Invoice::STATUS_OVERDUE) {
                    ...
                    return '<div class="flex flex-col gap-1"><p class="label-canceled">'.trans('admin::app.sales.invoices.index.datagrid.overdue').'</p><p class="block text-xs italic leading-5 text-rose-600">'.$extra.'</p></div>';
                }
