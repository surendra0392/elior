    ...
    public function prepareColumns(): void
    {
        $this->addColumn([
            ...
            'closure' => function ($row) {
                return '<a href="'.route('admin.sales.orders.view', ['id' => $row->increment_id]).'" class="text-[#205132] font-semibold hover:underline">#'.$row->increment_id.'</a>';
            },
        ]);
        ...
        $this->addColumn([
            ...
            'closure' => function ($row) {
                if (! empty($row->is_guest)) {
                    return $row->customer_name.' ('.trans('admin::app.sales.rma.all-rma.index.datagrid.guest').')';
                }
