    ...
    public function prepareColumns()
    {
        ...
        $this->addColumn([
            ...
            'closure' => function ($row) {
                return '<a href="'.route('admin.sales.invoices.view', $row->invoice_id).'" class="text-[#205132] font-semibold hover:underline" target="_blank">#'.$row->invoice_id.'</a>';
            },
        ]);
        ...
        $this->addColumn([
            ...
            'sortable' => true,
            'closure' => function ($row) {
                return '<a href="'.route('admin.sales.orders.view', $row->order_id).'" class="text-[#205132] font-semibold hover:underline" target="_blank">#'.$row->order_id.'</a>';
            },
        ]);
