    ...
    public function prepareColumns()
    {
        ...
        $this->addColumn([
            ...
            'closure' => function ($row) {
                return '<a href="'.route('admin.settings.data_transfer.imports.download', $row->id).'" class="cursor-pointer text-[#205132] font-semibold hover:underline">'.$row->file_path.'</a>';
            },
        ]);
        ...
        $this->addColumn([
            ...
            'closure' => function ($row) {
                ...
                return '<a href="'.route('admin.settings.data_transfer.imports.download_error_report', $row->id).'" class="cursor-pointer text-[#205132] font-semibold hover:underline">'.$row->error_file_path.'</a>';
            },
        ]);
