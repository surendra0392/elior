...
return [
    ...
    [
        ...
        'key' => 'cms.pages',
        'name' => 'admin::app.components.layouts.sidebar.pages',
        'route' => 'admin.cms.index',
        'sort' => 1,
        'icon' => '',
    ], [
        'key' => 'cms.hero_sliders',
        'name' => 'admin::app.components.layouts.sidebar.hero-sliders',
        'route' => 'admin.cms.hero_sliders.index',
        'sort' => 2,
        'icon' => '',
    ],
