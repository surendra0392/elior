...
Route::prefix('settings')->group(function () {
    ...
    Route::prefix('shipping')->group(function () {
        ...
        Route::controller(\Webkul\Admin\Http\Controllers\Settings\ShippingZoneController::class)->prefix('shipping-zones')->group(function () {
            ...
            Route::post('create', 'store')->name('admin.settings.shipping.zones.store');

            Route::get('edit/{id}', 'edit')->name('admin.settings.shipping.zones.edit');

            Route::put('edit/{id}', 'update')->name('admin.settings.shipping.zones.update');

            Route::delete('{id}', 'destroy')->name('admin.settings.shipping.zones.delete');
        });
    });
});
