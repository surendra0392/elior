...
Route::prefix('sales')->group(function () {
    ...
    Route::controller(OrderController::class)->prefix('orders')->group(function () {
        ...
        Route::post('store/{cartId}', 'store')->name('admin.sales.orders.store');
        ...
        Route::post('comment/{id}', 'comment')->name('admin.sales.orders.comment');

        Route::post('update-operational-status/{id}', 'updateOperationalStatus')->name('admin.sales.orders.update_operational_status');

        Route::get('search', 'search')->name('admin.sales.orders.search');

        Route::post('validate-order', 'validateOrder')->name('admin.sales.orders.validate_order');

        Route::get('print/{id}', 'printPackingSlip')->name('admin.sales.orders.print');

        Route::get('delivery-slip/{id}', 'printDeliverySlip')->name('admin.sales.orders.delivery_slip.print');
    });
    ...
    Route::controller(ShipmentController::class)->prefix('shipments')->group(function () {
        ...
        Route::get('print/{id}', 'printPackingSlip')->name('admin.sales.shipments.print');

        Route::get('delivery-slip/{id}', 'printDeliverySlip')->name('admin.sales.shipments.delivery_slip.print');
    });
