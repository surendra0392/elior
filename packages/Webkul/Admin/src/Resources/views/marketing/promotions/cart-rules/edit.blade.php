<x-admin::layouts>
    ...
    @pushOnce('scripts')
                    ...
                    <div class="box-shadow rounded bg-white p-4">
                        ...
                        <template v-if="parseInt(couponType)">
                            ...
                            <div
                                ...
                                class="mb-4 overflow-hidden rounded-[14px] bg-gradient-to-r from-[#205132] via-[#2d6e44] to-[#83B740] p-4 shadow-md text-white"
                            >
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="text-sm font-semibold text-white">
                                                @lang('admin::app.marketing.promotions.cart-rules.edit.auto-generate-banner-title')
                                            </p>

                                            <p class="text-xs text-white/80">
                                                @lang('admin::app.marketing.promotions.cart-rules.edit.auto-generate-banner-description')
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <x-admin::form.control-group>
                            ...
                            <p class="mt-1 block text-xs italic leading-5 text-gray-600">
                        ...
                        <x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group.control
                                ...
                                value="1"
                                :checked="old('first_order_only') ?? $cartRule->first_order_only"
                            />

                            <p class="mt-1 block text-xs italic leading-5 text-gray-600">
                                If enabled, this rule will only apply to customers with 0 previous orders.
                            </p>
                        </x-admin::form.control-group>
                    </div>
                        ...
                        <div class="grid gap-1.5">
                            ...
                            <x-admin::form.control-group>
                                ...
                                <p class="mt-1 block text-xs italic leading-5 text-gray-600">
                                    ...
                                    <span v-if="actionType === 'by_fixed'">@lang('admin::app.marketing.promotions.cart-rules.edit.action-type-info-by-fixed')</span>
                                    <span v-if="actionType === 'cart_fixed'">@lang('admin::app.marketing.promotions.cart-rules.edit.action-type-info-cart-fixed')</span>
                                    <span v-if="actionType === 'buy_x_get_y'">@lang('admin::app.marketing.promotions.cart-rules.edit.action-type-info-buy-x-get-y')</span>
                                </p>
                            </x-admin::form.control-group>
                            ...
                            <div class="flex gap-4 max-sm:flex-wrap">
                                <div class="w-full">
                                    ...
                                    <x-admin::form.control-group>
                                        <x-admin::form.control-group.label class="required">
                                            <span v-if="actionType === 'by_percent'">@lang('admin::app.marketing.promotions.cart-rules.edit.discount-percent')</span>
                                            <span v-if="actionType === 'buy_x_get_y'">@lang('admin::app.marketing.promotions.cart-rules.edit.free-quantity')</span>
                                            <span v-if="actionType !== 'by_percent' && actionType !== 'buy_x_get_y'">@lang('admin::app.marketing.promotions.cart-rules.edit.discount-amount')</span>
                                        </x-admin::form.control-group.label>
                                ...
                                <div class="w-full">
                                    ...
                                    <x-admin::form.control-group v-if="actionType === 'buy_x_get_y'">
                                        <x-admin::form.control-group.label class="required">
                                    ...
                                    <x-admin::form.control-group v-if="actionType !== 'cart_fixed' && actionType !== 'buy_x_get_y'">
                                        <x-admin::form.control-group.label>
                                            @lang('admin::app.marketing.promotions.cart-rules.edit.maximum-discounted-quantity')
                                        </x-admin::form.control-group.label>
                                        ...
                                        <x-admin::form.control-group.control
                                            ...
                                            :label="trans('admin::app.marketing.promotions.cart-rules.edit.maximum-discounted-quantity')"
                                            :placeholder="trans('admin::app.marketing.promotions.cart-rules.edit.maximum-discounted-quantity')"
                                        />
                            ...
                            >
                                <div class="w-full">
                                    <x-admin::form.control-group>
                                        <x-admin::form.control-group.label>
                                            @lang('admin::app.marketing.promotions.cart-rules.edit.maximum-eligible-quantity')
                                        </x-admin::form.control-group.label>
                                        ...
                                        <x-admin::form.control-group.control
                                            ...
                                            name="discount_quantity"
                                            :value="old('discount_quantity') ?? $cartRule->discount_quantity"
                                            :label="trans('admin::app.marketing.promotions.cart-rules.edit.maximum-eligible-quantity')"
                                            :placeholder="trans('admin::app.marketing.promotions.cart-rules.edit.maximum-eligible-quantity')"
                                        />
                                ...
                                <div class="w-full">
                                    ...
                                    <x-admin::form.control-group>
                                        ...
                                        <p
                                            ...
                                            class="mt-1 block text-xs italic leading-5 text-gray-600"
                                        >
            ...
            <div class="mt-4 flex justify-between gap-4">
                <div class="flex flex-1 gap-4 max-sm:flex-1 max-sm:flex-wrap">
                    <select
                        ...
                        class="custom-select min:w-1/3 flex h-10 w-1/3 rounded-md border bg-white px-3 py-2.5 text-sm font-normal text-gray-600 transition-all hover:border-gray-400 max-sm:max-w-full max-sm:flex-auto"
                    ...
                    <select
                        ...
                        class="custom-select inline-flex h-10 w-full max-w-[196px] items-center justify-between gap-x-1 rounded-md border bg-white px-3 py-2.5 text-sm font-normal text-gray-600 transition-all hover:border-gray-400 max-sm:max-w-full max-sm:flex-auto"
                    ...
                    <div v-if="matchedAttribute">
                        ...
                        <div v-else>
                            ...
                            >
                                ...
                                >
                                    <input
                                        ...
                                        class="min:w-1/3 flex h-10 w-[289px] rounded-md border px-3 py-2.5 text-sm text-gray-600 transition-all hover:border-gray-400 focus:border-gray-400"
                                    />
                                </v-field>
                            ...
                            <div v-if="matchedAttribute.type == 'boolean'">
                                <select
                                    :name="['conditions[' + index + '][value]']"
                                    class="custom-select inline-flex h-10 w-full min-w-[196px] items-center justify-between gap-x-1 rounded-md border bg-white px-3 py-2.5 text-sm font-normal text-gray-600 transition-all hover:border-gray-400 max-sm:max-w-full max-sm:flex-auto"
                                    v-model="condition.value"
                                >
                                    <option value="1">
                                        @lang('admin::app.marketing.promotions.cart-rules.edit.yes')
                            ...
                            <div v-if="matchedAttribute.type == 'select' || matchedAttribute.type == 'radio'">
                                <select
                                    :name="['conditions[' + index + '][value]']"
                                    class="custom-select inline-flex h-10 w-full min-w-[196px] items-center justify-between gap-x-1 rounded-md border bg-white px-3 py-2.5 text-sm font-normal text-gray-600 transition-all hover:border-gray-400"
                                ...
                                <select
                                    :name="['conditions[' + index + '][value]']"
                                    class="custom-select inline-flex max-h-10 w-full max-w-[196px] items-center justify-between gap-x-1 rounded-md border bg-white px-3 py-2.5 text-sm font-normal text-gray-600 transition-all hover:border-gray-400 max-sm:max-w-full max-sm:flex-auto"
                                    v-model="condition.value"
                                    v-else
                                >
                                    <optgroup
                            ...
                            <div v-if="matchedAttribute.type == 'multiselect' || matchedAttribute.type == 'checkbox'">
                                <select
                                    :name="['conditions[' + index + '][value][]']"
                                    class="inline-flex h-10 w-[196px] max-w-[196px] items-center justify-between gap-x-1 rounded-md border px-3 py-2 text-sm text-gray-600 transition-all hover:border-gray-400 focus:border-gray-400"
                                    v-model="condition.value"
                                    multiple
                                >
                                    <option
                ...
                <span
                    class="icon-delete max-w-9 max-h-9 cursor-pointer rounded-md p-1.5 text-2xl transition-all hover:bg-gray-100 max-sm:place-self-center"
        ...
        >
            <div
                class="box-shadow rounded bg-white p-4"
                                ...
                                <x-admin::form.control-group>
                                    ...
                                    >
                                        @foreach (['alphanumeric', 'alphabetical', 'numeric'] as $item)
                                            <option value="{{ $item }}">
                                                @lang('admin::app.marketing.promotions.cart-rules.edit.' . $item)
                                            </option>
                                        @endforeach
                                    </x-admin::form.control-group.control>
