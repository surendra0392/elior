                        ...
                        <div class="grid gap-1.5">
                            ...
                            <x-admin::form.control-group>
                                ...
                                <p class="mt-1 block text-xs italic leading-5 text-gray-600">
                                    ...
                                    <span v-if="actionType === 'by_fixed'">@lang('admin::app.marketing.promotions.cart-rules.create.action-type-info-by-fixed')</span>
                                    <span v-if="actionType === 'cart_fixed'">@lang('admin::app.marketing.promotions.cart-rules.create.action-type-info-cart-fixed')</span>
                                    <span v-if="actionType === 'buy_x_get_y'">@lang('admin::app.marketing.promotions.cart-rules.create.action-type-info-buy-x-get-y')</span>
                                </p>
                            </x-admin::form.control-group>
                            ...
                            <div class="flex gap-4 max-sm:flex-wrap">
                                ...
                                <x-admin::form.control-group class="w-full">
                                    <x-admin::form.control-group.label class="required">
                                        ...
                                        <span v-if="actionType === 'buy_x_get_y'">@lang('admin::app.marketing.promotions.cart-rules.create.free-quantity')</span>
                                        <span v-if="actionType !== 'by_percent' && actionType !== 'buy_x_get_y'">@lang('admin::app.marketing.promotions.cart-rules.create.discount-amount')</span>
                                    </x-admin::form.control-group.label>
                    ...
                    <div v-if="matchedAttribute">
                        ...
                        <div v-else>
                            ...
                            <div v-if="matchedAttribute.type == 'boolean'">
                                <select
                                    :name="['conditions[' + index + '][value]']"
                                    class="custom-select inline-flex h-10 w-[196px] max-w-[196px] items-center justify-between gap-x-1 rounded-md border bg-white px-3 py-2.5 text-sm font-normal text-gray-600 transition-all hover:border-gray-400"
                                    v-model="condition.value"
                                >
                                    <option value="1">
                                        @lang('admin::app.marketing.promotions.cart-rules.create.yes')
