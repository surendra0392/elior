                ...
                <template #body="{
                    ...
                    <template v-else>
                        <div
                            ...
                            class="row grid items-center gap-2.5 break-all border-b px-4 py-4 text-gray-600 transition-all hover:bg-gray-50"
                    ...
                    <x-admin::modal ref="sitemapUpdateOrCreateModal">
                        ...
                        <x-slot:content>
                            ...
                            <x-admin::form.control-group>
                                ...
                                <p class="mt-2 text-xs font-medium text-gray-600 ltr:ml-1 rtl:mr-1">
