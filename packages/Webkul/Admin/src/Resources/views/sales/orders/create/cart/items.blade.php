        ...
        <div class="box-shadow rounded bg-white">
            <div class="flex justify-between p-4">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <template v-else>
                        <p class="flex flex-col gap-1 text-base font-semibold text-gray-800">
            ...
            >
                <div
                    class="row grid gap-4 border-b bg-white p-4 transition-all hover:bg-gray-50"
                    ...
                    <div class="flex justify-between gap-2.5">
                        <div class="flex gap-2.5">
                            ...
                            <div
                                ...
                                :class="{'overflow-hidden rounded border border-dashed border-gray-300': ! item.product.images.length}"
                            >
                            ...
                            <div class="flex flex-col gap-1.5">
                                <!-- Item Name -->
                                <p class="whitespace-nowrap text-base font-semibold text-gray-800">
                                    @{{ item.name }}
                                </p>
                                ...
                                >
                                    <!-- Details Toggler -->
                                    <p
                                        class="flex cursor-pointer items-center gap-1 text-sm text-gray-800"
                        ...
                        <div class="flex flex-col gap-2">
                            <p class="flex flex-col gap-1 text-right text-base font-semibold text-gray-800">
                                <template v-if="displayTax.subtotal == 'including_tax'">
            ...
            <div
                ...
                v-else
            >
                <img src="{{ bagisto_asset('images/icon-add-product.svg') }}" class="h-20 w-20">
            ...
            >
                ...
                <x-slot:content class="!p-0">
                    ...
                    >
                        <div
                            class="flex justify-between gap-2.5 border-b border-slate-300 px-4 py-6"
                            ...
                            >
                                <form @submit="handleSubmit($event, addToCart)">
                                    <div class="grid place-content-start gap-2 text-right">
                                        ...
                                        <button
                                            class="cursor-pointer text-sm text-[#205132] transition-all hover:underline"
