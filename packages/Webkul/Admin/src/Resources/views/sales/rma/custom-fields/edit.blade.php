            ...
            >
                <div class="flex gap-2.5 mt-3.5">
                    ...
                    <div class="flex flex-col gap-2 flex-1 overflow-auto">
                                    ...
                                    <x-slot:content class="!p-0">
                                        @foreach ($channels as $channel)
                                            <a
                                                ...
                                                class="flex cursor-pointer gap-2.5 px-5 py-2 text-base hover:bg-gray-100"
                                            >
                                                {{ $channel->name }}
                                            </a>
                                        @endforeach
                        ...
                        <!-- General -->
                        <div class="bg-white box-shadow rounded">
                                ...
                                <x-admin::form.control-group>
                                    ...
                                    >
                                        <input
                                            type="text"
                                            id="code"
                                            class="flex w-full min-h-[39px] py-2 px-3 border rounded-md text-sm text-gray-600 transition-all hover:border-gray-400 focus:border-gray-400"
                                            name="slug"
                                            v-bind="field"
