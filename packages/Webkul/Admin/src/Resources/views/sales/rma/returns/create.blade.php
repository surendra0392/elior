            ...
            <div class="w-full overflow-auto">
                <x-admin::datagrid :src="route('admin.sales.rma.requests.create')" >
                            ...
                            <div class="row datagrid-head datagrid-head-cards grid grid-cols-[0.5fr_1fr_1fr_0.5fr_1fr_1fr_0.1fr] grid-rows-1">
                                ...
                                >
                                    <p class="text-gray-600">
                                        ...
                                        <i
                                            class="ltr:ml-1.5 rtl:mr-1.5 text-base text-gray-800 align-text-bottom"
                    ...
                    <template #body="{
                        ...
                        <template v-if="! isLoading">
                            <div
                                class="row datagrid-card grid grid-cols-[0.5fr_1fr_1fr_0.5fr_1fr_1fr_0.1fr] grid-rows-1 px-4 py-2.5 border-b transition-all hover:bg-gray-50"
                    ...
                    >
                        <x-admin::modal ref="rmaModel" panel-class="max-w-[768px]">
                            ...
                            <x-slot:content class="bg-gray-50">
                                <div
                                    class="journal-scroll flex flex-col gap-3 overflow-auto ltr:pr-1.5 rtl:pl-1.5"
                            ...
                            <x-slot:footer>
                                <div class="flex justify-end">
                                    ...
                                    >
                                        <svg v-if="!rmaFormSubmit" aria-hidden="true" class="w-5 h-5 text-gray-200 animate-spin fill-[#205132]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div v-if="products.length > 0">
                                ...
                                <p class="flex text-sm justify-between">
                                    <template v-if="product.url_key && product.visible_individually">
                                        <a
                                            ...
                                            target='_blank'
                                            class="text-base font-semibold text-[#205132] hover:underline"
                                        >
                                            @{{ product.name }}
                                ...
                                <p class="w-full" v-if="product.rma_return_period">
                                    <div class="mt-4" v-if="isChecked[getProductId(product)] && product.currentQuantity > '0'">
                                        <x-admin::form.control-group>
                                            ...
                                            <x-admin::form.control-group.error name="resolution_type" class="flex"/>
                                        </x-admin::form.control-group>
                                    </div>
                                </p>
                                ...
                                <p class="mt-4 w-full">
                                    ...
                                    >
                                        <x-admin::form.control-group>
                                            ...
                                            <x-admin::form.control-group.error name="rma_reason_id" class="flex"/>
                                        </x-admin::form.control-group>
                                    </div>
                                </p>
                            </div>
                                    ...
                                    <div class="flex gap-3">
                                        ...
                                        <p class="w-full">
                                            <x-admin::form.control-group>
                                                ...
                                                <x-admin::form.control-group.error name="rma_qty" class="flex"/>
                                            </x-admin::form.control-group>
                                        </p>
                ...
                >
                                ...
                                @case('checkbox')
                                    @foreach($attribute->options ?? [] as $option)
                                        <x-admin::form.control-group class="flex gap-2.5 items-center !mb-2 select-none">
                                            ...
                                            <label
                                                class="text-xs text-gray-600 font-medium cursor-pointer"
                                                for="{{ $option->name }}"
                                            >
                                                {{$option->name}}
                                            </label>
                    ...
                    <x-admin::form.control-group class="mt-4">
                        <x-admin::form.control-group.label class="text-sm flex text-gray-700">
                        ...
                        <!-- Upload box -->
                        <label class="flex items-center justify-center w-full px-4 py-3 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 text-gray-600 transition">
