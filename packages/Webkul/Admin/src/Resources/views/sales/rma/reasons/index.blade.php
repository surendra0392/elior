                                ...
                                @if ($hasEditPermission)
                                    <a @click="selectedLocales=1; editModal(record.actions.find(action => action.index === 'edit')?.url)">
                                        <span
                                            ...
                                            class="cursor-pointer rounded-md p-1 text-2xl transition-all hover:bg-gray-200 max-sm:place-self-center"
                                        >
                                        </span>
                                    </a>
                                @endif
                                ...
                                @if ($hasDeletePermission)
                                    <a @click="performAction(record.actions.find(action => action.method === 'DELETE'))">
                                        <span
                                            ...
                                            class="icon-delete cursor-pointer rounded-md p-2 text-2xl transition-all hover:bg-gray-200 max-sm:place-self-center"
                    ...
                    >
                        {!! view_render_event('bagisto.admin.catalog.rma.create_form_controls.before') !!}
                            ...
                            <x-admin::modal ref="reasonsModal">
                                <!-- Modal Header -->
                                <x-slot:header>
                                    <p v-if="! selectedLocales" class="text-lg font-bold text-gray-800">
                                        @lang('admin::app.sales.rma.reasons.create.create-title')
                                    </p>

                                    <p v-else class="text-lg font-bold text-gray-800">
