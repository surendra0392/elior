            ...
            <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
                ...
                <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                    ...
                    <div class="box-shadow rounded bg-white">
                        ...
                        <div class="grid">
                            <div class="flex justify-between gap-2.5 border-b border-slate-300 px-4 py-6 !pt-0">
                    ...
                    <div class="box-shadow rounded bg-white">
                        ...
                        @if ($rmaItem = $rma->item) 
                            <div class="flex gap-2.5">
                                ...
                                <p class="py-4 break-words text-base font-semibold text-gray-800">
                            ...
                            @if ($canTakeOrderAction)
                                ...
                                <div class="flex flex-wrap items-center justify-between gap-3 border-t border-slate-300 px-4 py-4">
                    ...
                    <div class="box-shadow rounded bg-white">
                        ...
                        <div class="flex flex-col-reverse">
                            <div class="border-t border-gray-200 p-4">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <x-admin::form.control-group>
                                            <x-admin::form.control-group.label class="required flex">
                                        ...
                                        <div class="mb-4">
                                            <button
                                                type="button"
                                                id="newFileInput"
                                                class="transparent-button text-sm hover:bg-gray-200"
                                            >
                                        ...
                                        <div class="flex justify-end">
                                            <button
                                                ...
                                                disabled
                                            >
                                                <svg  aria-hidden="true" class="w-4 h-4 text-gray-200 animate-spin fill-[#205132]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <!-- Messages List -->
                            <div
                                class="flex flex-col-reverse overflow-y-auto p-5 bg-gray-50"
                                style="height: 320px;"
                                @wheel="getNewMessage()"
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <div class="flex-shrink-0">
                                                    <div v-if="message.is_admin == 1" class="w-8 h-8 rounded-full bg-[#205132] flex items-center justify-center text-white font-bold">
                                                ...
                                                <div
                                                    :class="[
                                                        ...
                                                        message.is_admin == 1 ? 'bg-[#205132]/10' : 'bg-white'
                                                    ]"
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        class="value text-sm font-medium text-gray-800"
                                                    ...
                                                    <div v-if="message.attachment" class="mt-2">
                                                        ...
                                                        <a
                                                            ...
                                                            class="icon-attribute text-base font-normal cursor-pointer hover:underline"
                                                        >
                                    ...
                                    @if ($rma->rma_status_id != DefaultRMAStatusEnum::CANCELED->value) 
                                        ...
                                        >
                                            <form @submit="handleSubmit($event, updateRMStatus)">
                                                <x-admin::accordion>
                                                    <x-slot:header>
                                                        <p class="p-3 text-base font-semibold text-gray-600 required">
                                ...
                                <div class="flex flex-col gap-y-1.5">
                                    ...
                                    <p class="text-gray-600">
                                        <a
                                            ...
                                            target="_blank"
                                            class="cursor-pointer text-[#205132] transition-all hover:underline"
                                        >
                                            {{ '#'. $rma->order_id }}
                                        </a>
                                    </p>
            ...
            app.component('v-admin-rma-view', {
                ...
                methods: {
                    ...
                    handleFileSelect($event) {
                        ...
                        removeButton.classList.add('text-[#205132]');
