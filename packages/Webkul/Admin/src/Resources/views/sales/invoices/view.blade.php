    ...
    <div class="flex items-center justify-between gap-4 mt-7 max-md:flex-wrap">
        <div class="flex flex-wrap items-center gap-x-1 gap-y-2">
            ...
            <a
                ...
                class="inline-flex w-full max-w-max cursor-pointer items-center justify-between gap-x-2 px-1 py-1.5 text-center font-semibold text-gray-600 transition-all hover:rounded-md hover:bg-gray-200"
                target="_blank"
            >
            ...
            <a
                ...
                target="_blank"
            >
                <span class="text-2xl icon-product"></span>
            ...
            <a
                ...
                target="_blank"
            >
                <span class="text-2xl icon-ship"></span>
    ...
    <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
        ...
        <div class="flex flex-col flex-1 gap-2 max-xl:flex-auto">
            ...
            <div class="bg-white rounded box-shadow">
                <p class="p-4 mb-4 text-base font-semibold text-gray-800">
                        ...
                        <div class="flex justify-between gap-2.5 border-b border-slate-300 px-4 py-6">
                            <div class="flex gap-2.5">
                                ...
                                <div class="grid place-content-start gap-1.5">
                                    <!-- Item Name -->
                                    <p 
                                        class="text-base font-semibold text-gray-800 break-all"
                                        v-pre
                                    >
                                        {{ $item->name }}
                                    </p>
                            ...
                            <div class="grid gap-1 place-content-start">
                                <!-- Item Grand Total -->
                                <p class="flex items-center justify-end text-base font-semibold text-gray-800 gap-x-1">
                ...
                <div class="mt-4 flex w-full justify-end gap-2.5 p-4">
                    <div class="flex flex-col gap-y-1.5">
                        ...
                        @php
                            ...
                            $taxAmount = (float) $invoice->base_tax_amount;
                        @endphp
                        ...
                        @if($taxAmount > 0)
                            ...
                            @endif
                        @else
                            <p class="!leading-5 text-gray-600">@lang('admin::app.sales.invoices.view.summary-tax')</p>
                        @endif
                    ...
                    <div class="flex flex-col gap-y-1.5">
                        ...
                        @if($taxAmount > 0)
                            @if($isIgst)
                                <p class="!leading-5 text-gray-600">{{ core()->formatBasePrice($invoice->base_tax_amount) }}</p>
                            @else
                                <p class="!leading-5 text-gray-600">{{ core()->formatBasePrice($invoice->base_tax_amount / 2) }}</p>
                                <p class="!leading-5 text-gray-600">{{ core()->formatBasePrice($invoice->base_tax_amount / 2) }}</p>
                            @endif
                        @else
                            <p class="!leading-5 text-gray-600">{{ core()->formatBasePrice($invoice->base_tax_amount) }}</p>
            ...
            <x-admin::accordion>
                ...
                <x-slot:content>
                    <div class="flex justify-start w-full gap-5">
                        ...
                        <div class="flex flex-col gap-y-1.5">
                            <!-- Order Id -->
                            <p class="font-semibold text-[#205132] transition-all hover:underline">
