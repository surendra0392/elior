...
@pushOnce('scripts')
    ...
    >
        <div class="mt-6">
            <div class="calendar-container rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
                <vue-cal
                    hide-view-selector
                    :watchRealTime="true"
                    :twelveHour="true"
                ...
                >
                    <!-- Left Arrow -->
                    <template #arrow-prev="">
                        <span class="icon-sort-left flex h-8 w-8 items-center justify-center rounded-full text-xl text-gray-500 transition-colors duration-200 hover:bg-gray-100 hover:text-gray-800"></span>
                    </template>

                    <!-- Right Arrow -->
                    <template #arrow-next="">
                        <span class="icon-sort-right flex h-8 w-8 items-center justify-center rounded-full text-xl text-gray-500 transition-colors duration-200 hover:bg-gray-100 hover:text-gray-800"></span>
                    </template>
                    ...
                    <template #event="{ event, view }">
                        <div
                            ...
                            :class="[
                                event.status === 'pending' ? 'border-amber-500 bg-amber-50/90 hover:bg-amber-100' :
                                event.status === 'completed' ? 'border-emerald-500 bg-emerald-50/90 hover:bg-emerald-100' :
                                event.status === 'closed' ? 'border-[#205132] bg-[#205132]/10/90 hover:bg-[#205132]/10' :
                                event.status === 'canceled' ? 'border-rose-500 bg-rose-50/90 hover:bg-rose-100' :
                                'border-emerald-500 bg-emerald-50/90 hover:bg-emerald-100',
                        ...
                        >
                            <div class="flex items-center gap-1 font-semibold text-gray-700">
                                <span
                                    ...
                                    :class="[
                                        ...
                                        event.status === 'closed' ? 'bg-[#205132]/100' :
                            ...
                            <div
                                ...
                                class="mt-1 truncate text-[11px] font-medium text-gray-600"
            ...
            <x-admin::modal ref="myModal">
                ...
                <x-slot:header>
                    <div class="flex w-full items-center justify-between gap-3">
                        <div class="flex items-center gap-3">
                            <span class="flex h-10 w-10 items-center justify-center rounded-full bg-[#205132]/10 text-[#205132]">
                        ...
                        <span
                            ...
                            :class="[
                                ...
                                event.status === 'closed' ? 'bg-[#205132]/10 text-[#205132]' :
                                event.status === 'canceled' ? 'bg-rose-100 text-rose-700' :
                ...
                <x-slot:content>
                    <div class="grid gap-5 text-sm font-normal">
                        <!-- Booking info -->
                        <div class="grid grid-cols-[120px_auto] gap-x-3 gap-y-2.5 rounded-lg border border-gray-100 bg-gray-50/60 p-4">
                            <!-- Booking Date -->
                            <div
                                class="text-gray-500"
                        ...
                        <!-- Customer info -->
                        <div class="grid gap-3 rounded-lg border border-gray-100 bg-gray-50/60 p-4 text-gray-700">
                            ...
                            <div class="flex items-center gap-2.5">
                                <span class="icon-customer-2 text-xl text-gray-400"></span>
                            ...
                            <!-- Customer Email -->
                            <div class="flex items-center gap-2.5">
                                <span class="icon-mail text-xl text-gray-400"></span>
                            ...
                            <div class="flex items-center gap-2.5">
                                <span class="icon-phone text-xl text-gray-400"></span>
                            ...
                            <div class="flex items-start gap-2.5">
                                <span class="icon-location mt-0.5 text-xl text-gray-400"></span>
