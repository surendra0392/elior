                    ...
                    <x-slot:content>
                        <div class="flex flex-col items-center gap-4">
                            ...
                            <div
                                ...
                                v-if="isLoading"
                            >
                                <div class="animate-spin rounded-full h-8 w-8 border-b-2 border-[#205132]"></div>
                            </div>
                            ...
                            >
                                <p class="text-center text-base font-semibold text-gray-800">
                                ...
                                <div class="mt-4 grid grid-cols-2 gap-2 rounded-md border bg-gray-50 p-4">
                                    <p
                                        class="text-center font-mono text-sm font-semibold tracking-widest text-gray-800"
