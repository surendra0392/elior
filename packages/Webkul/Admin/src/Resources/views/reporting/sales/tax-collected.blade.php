            ...
            <div class="box-shadow relative flex-1 rounded bg-white p-4">
                ...
                <div class="grid gap-4">
                    <div class="flex justify-between gap-4">
                        <p class="text-3xl font-bold leading-9 text-gray-600">
                        ...
                        <div class="flex items-center gap-0.5">
                            <span
                                ...
                                :class="[report.statistics.tax_collected.progress < 0 ? 'icon-down-stat text-red-500' : 'icon-up-stat text-emerald-500']"
                            ></span>
                    ...
                    <!-- Tax Categories -->
                    <p class="py-2.5 text-base font-semibold text-gray-600">
