                            ...
                            >
                                <div class="flex items-center gap-2">
                                    <a
                                        v-if="coupon.link"
                                        :href="coupon.link"
                                        class="rounded bg-emerald-100 px-2 py-0.5 font-mono text-xs font-semibold text-emerald-700 transition-all hover:bg-emerald-200"
                                    >
                                        @{{ coupon.coupon_code }}
                                    </a>
                                    ...
                                    <span
                                        v-else
                                        class="rounded bg-gray-100 px-2 py-0.5 font-mono text-xs font-semibold text-gray-700"
                                    >
                                        @{{ coupon.coupon_code }}
                                    </span>
