...
@pushOnce('scripts')
    ...
    >
        ...
        <template v-else>
            <div class="box-shadow relative flex-1 rounded bg-white p-4">
                ...
                <div class="grid gap-4">
                    ...
                    <div class="flex justify-between gap-4">
                        ...
                        <div class="grid gap-1">
                            ...
                            <p class="text-xs font-semibold leading-none text-gray-600">
                        ...
                        <div class="grid gap-1">
                            ...
                            <div class="flex items-center gap-0.5">
                                <span
                                    class="text-base text-emerald-500"
                                    :class="[report.statistics.carts.progress < 0 ? 'icon-down-stat text-red-500' : 'icon-up-stat text-emerald-500']"
                                ></span>
                    ...
                    <!-- Header -->
                    <p class="mt-4 py-2.5 text-base font-semibold text-gray-600">
                            ...
                            >
                                ...
                                <div class="flex items-center gap-5">
                                    <div class="relative h-2 w-full bg-slate-100">
                                        <div
                                            class="absolute left-0 h-2 bg-[#205132]/100"
                    ...
                    <div class="flex justify-end gap-5">
                        <div class="flex items-center gap-1">
                            <span class="h-3.5 w-3.5 rounded-md bg-[#205132]/100"></span>
