            ...
            <div>
                    ...
                    <div class="flex items-center gap-1.5">
                       <!-- Back Button -->
                        ...
                        <x-admin::dropdown position="bottom-right">
                            ...
                            <x-slot:menu class="!p-0 shadow-[0_5px_20px_rgba(0,0,0,0.15)]">
                    ...
                    <div class="flex items-center gap-x-1">
                        ...
                        <template v-if="channels.length > 2">
                            <x-admin::dropdown position="bottom-{{ core()->getCurrentLocale()->direction === 'ltr' ? 'left' : 'right' }}" >
                                <x-slot:toggle>
                                    <button
                                        type="button"
                                        class="transparent-button px-1 py-1.5 hover:bg-gray-200 focus:bg-gray-200"
                                    >
                        ...
                        @if (in_array(request()->query('type'), [
                            ...
                            <div class="relative inline-flex w-full max-w-max">
                                <select
                                    class="w-full cursor-pointer appearance-none rounded-md border bg-white px-2.5 py-1.5 pr-8 text-center leading-6 text-gray-600 transition hover:border-gray-400 focus:border-gray-400"
                                ...
                                <span class="icon-sort-down pointer-events-none absolute right-2 top-1/2 -translate-y-1/2 transform text-2xl text-gray-600"></span>
                            </div>
                        @endif
                    </div>
                ...
                <div class="table-responsive box-shadow grid w-full overflow-hidden rounded bg-white">
                    ...
                    <template v-else>
                        ...
                        >
                            ...
                            >
                                ...
                                <span
                                    ...
                                    :class="{
                                        'icon-sort-up text-[#205132]': sortColumn === column.key && sortDirection === 'asc',
                                        'icon-sort-down text-[#205132]': sortColumn === column.key && sortDirection === 'desc',
                        ...
                        <!-- Table Body -->
                        <div
                            class="row grid items-center gap-2.5 border-b px-4 py-4 text-gray-600 transition-all hover:bg-gray-50" style="grid-template-columns: repeat(4, minmax(0, 1fr));"
                            :style="`grid-template-columns: repeat(${reporting.statistics.columns.length}, minmax(0, 1fr))`"
                        ...
                        >
                            <p v-for="column in reporting.statistics.columns">
                                <a
                                    ...
                                    class="text-[#205132] transition-all hover:underline"
                                >
                                    @{{ record[column.key] }}
                                </a>
