    ...
    <div style="margin-bottom: 34px;">
        ...
        <p style="font-size: 16px;color: #205132;line-height: 24px;">
            {!! trans('admin::app.emails.orders.created.greeting', [
                'order_id' => '<a href="' . route('admin.sales.orders.view', $order->id) . '" style="color: #83B740;">#' . $order->increment_id . '</a>',
            ...
            <div style="display: grid;gap: 100px;grid-template-columns: repeat(2, minmax(0, 1fr));">
                <span>
                    ...
                    @if($order->coupon_code)
                        <br><span style="font-size: 12px; color: #83B740;">({{ $order->coupon_code }})</span>
                    @endif
                </span>
