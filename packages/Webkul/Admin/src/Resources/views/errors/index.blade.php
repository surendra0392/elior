<x-admin::layouts.anonymous>
	...
	<div class="flex h-[100vh] items-center justify-center bg-white">
        <div class="flex max-w-[745px] items-center gap-5">
            <div class="w-full">
				...
				<div class="text-[38px] font-bold text-gray-800">
                    {{ $errorCode }}
                </div>
                ...
                <div class="mb-6">
                    <div class="flex items-center gap-2.5">
                        <a
                            ...
                            class="text-sm font-semibold text-[#205132] transition-all hover:underline"
                        >
                ...
                <p class="text-sm text-gray-800">
                    @lang('admin::app.errors.support', [
                        ...
                        'class' => 'font-semibold text-[#205132] transition-all hover:underline',
                    ])
                </p>
            </div>
