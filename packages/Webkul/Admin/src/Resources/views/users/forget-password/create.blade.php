<x-admin::layouts.anonymous>
    ...
    <div class="min-h-screen nature-card-bg flex items-center justify-center p-3 sm:p-6 lg:p-10">
        ...
        <div class="auth-container-card w-full max-w-[1040px] grid grid-cols-1 lg:grid-cols-12">
            ...
            <!-- Left Side: Nature Landscape with "WELCOME" & Deer -->
            ...
            <!-- Right Side: Deep Forest Teal Password Recovery Form -->
            <div class="lg:col-span-6 p-6 sm:p-10 lg:p-12 flex flex-col justify-between relative bg-[#1E6B5C]">
                ...
                <div class="my-auto py-4 space-y-6">
                    ...
                    <!-- Recovery Form -->
                    <x-admin::form :action="route('admin.forget_password.store')" class="space-y-4">
                        ...
                        <div class="pt-3">
                            ...
                            >
                                <span>@lang('admin::app.users.forget-password.create.submit-btn')</span>
                ...
                <div class="pt-4 text-center text-xs text-white/50 space-y-1">
                    <div class="inline-flex items-center gap-1.5 justify-center">
                        ...
                        <span>Encrypted Recovery Token Protocol</span>
                    </div>
                </div>
