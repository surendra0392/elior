    ...
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-0.5 text-xs text-slate-500">
                Moderate botanical powder customer feedback, ratings, and approve published reviews.
            </p>
        </div>
    </div>
        ...
        >
            ...
            >
                ...
                <template #body="{
                    ...
                    <template v-else>
                        <div
                            class="row grid grid-cols-1 gap-2 md:grid-cols-[2fr_1fr_minmax(150px,_4fr)_0.5fr] md:gap-0 border-b px-4 py-2.5 transition-all hover:bg-gray-50 min-w-full"
                            ...
                            <div class="flex place-content-end items-center gap-1.5 self-center">
                                ...
                                <a @click="performAction(record.actions.find(action => action.index === 'delete'))">
                                    <span
                                        ...
                                        class="cursor-pointer rounded-md p-1.5 text-2xl transition-all hover:bg-gray-200 ltr:ml-1 rtl:mr-1"
                                    >
                                    </span>
                                </a>
                                ...
                                >
                                    <span class="icon-sort-right rtl:icon-sort-left cursor-pointer rounded-md p-1.5 text-2xl transition-all hover:bg-gray-200 ltr:ml-1 rtl:mr-1"></span>
                                </a>
                            </div>
                        </div>
                    </template>
                        ...
                        <x-admin::drawer ref="review">
                            ...
                            <x-slot:content>
                                <div class="flex flex-col gap-4 px-1.5 py-2.5">
                                    ...
                                    <div class="w-full">
                                        <p class="block text-xs font-medium leading-6 text-gray-800">
                                    ...
                                    <div class="w-full">
                                        <p class="block text-xs font-semibold leading-6 text-gray-600">
