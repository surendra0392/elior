                            ...
                            <span class="[&>*]:after:content-['_/_']">
                                <template v-for="column in columnGroup">
                                    <span
                                        ...
                                        :class="{
                                            'font-medium text-gray-800': applied.sort.column == column,
        ...
        <template #body="{
            ...
            <template v-else>
                <div 
                    ...
                    class="grid gap-y-4 border-b p-4 transition-all hover:bg-gray-50"
                ...
                >
                    <div class="flex justify-start [&amp;>*]:flex-1">
                        <div class="flex flex-col gap-1.5">
                            <!-- Review Name -->
                            <p  
                                class="text-base font-semibold leading-none text-gray-800"
                                v-text="record.name"
                            >
                            </p>
                    ...
                    <div class="flex items-center justify-between gap-x-4">
                        ...
                        <a 
                            ...
                            target="_blank"
                            class="icon-sort-right rtl:icon-sort-left cursor-pointer rounded-md p-1.5 text-2xl transition-all hover:bg-gray-200 ltr:ml-1 rtl:mr-1"
                        >
                        </a>
                    </div>
                </div>
