        ...
        <template #body="{
            ...
            <template v-else>
                <div
                    ...
                    class="row datagrid-card grid grid-cols-4 gap-y-4 border-b px-4 py-2.5 transition-all hover:bg-gray-50"
                ...
                >
                    ...
                    <div class="flex items-center justify-end gap-x-2">
                        <a :href="'{{ route('admin.sales.orders.view', ':id') }}'.replace(':id', record.id)">
                            <span class="icon-sort-right rtl:icon-sort-left cursor-pointer p-1.5 text-2xl hover:rounded-md hover:bg-gray-200 ltr:ml-1 rtl:mr-1"></span>
                        </a>
                    </div>
                </div>
