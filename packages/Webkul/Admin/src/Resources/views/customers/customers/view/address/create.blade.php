<v-create-customer-address @address-created="addressCreated">
    <div class="mr-1 inline-flex w-full max-w-max cursor-pointer items-center justify-between gap-x-2 px-1 py-1.5 text-center font-semibold text-gray-600 transition-all hover:rounded-md hover:bg-gray-200">
...
@pushOnce('scripts')
    ...
    >
        ...
        @if (bouncer()->hasPermission('customers.addresses.create'))
            <div
                class="flex cursor-pointer items-center justify-between gap-1.5 px-2.5 text-[#205132] transition-all hover:underline"
