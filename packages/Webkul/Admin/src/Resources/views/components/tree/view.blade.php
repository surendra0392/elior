                    ...
                    children.push(
                        this.$h('div', {
                            ...
                            this.$h('input', {
                                ...
                                class: 'block h-10 w-full rounded-lg border bg-white text-sm text-gray-600 transition-all hover:border-gray-400 focus:border-gray-400 ltr:pl-3 ltr:pr-10 rtl:pl-10 rtl:pr-3',
