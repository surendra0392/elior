...
@pushOnce('scripts')
        ...
        <div class="grid">
            <div class="flex flex-wrap gap-1">
                ...
                <template v-if="allowMultiple || images.length == 0">
                    ...
                    <label
                        class="grid h-[120px] max-h-[120px] min-h-[110px] w-full min-w-[110px] max-w-[120px] cursor-pointer items-center justify-items-center rounded border border-dashed border-[#205132]/20 transition-all hover:border-[#205132]"
                        :style="{'max-width': this.width, 'max-height': this.height}"
                        v-if="ai.enabled"
                        @click="resetAIModal(); $refs.magicAIImageModal.open()"
                    >
                        <div class="flex flex-col items-center">
                            <span class="icon-magic text-2xl text-[#205132]"></span>

                            <p class="grid text-center text-sm font-semibold text-[#205132]">
                    ...
                    <!-- Upload Image Button -->
                    <label
                        class="grid h-[120px] max-h-[120px] min-h-[110px] w-full min-w-[110px] max-w-[120px] cursor-pointer items-center justify-items-center rounded border border-dashed border-gray-300 transition-all hover:border-gray-400"
                    ...
                    >
                        <div class="flex flex-col items-center">
                            ...
                            <p class="grid text-center text-sm font-semibold text-gray-600">
                            ...
                            >
                                ...
                                <x-slot:header>
                                    <template v-if="! ai.images.length">
                                        <p class="flex items-center gap-2.5 text-lg font-bold text-gray-800">
                                    ...
                                    <template v-else>
                                        <p class="truncate text-lg font-bold text-gray-800">
                                            <span
                                                class="icon-arrow-right mr-1 cursor-pointer align-middle text-2xl hover:rounded-md hover:bg-gray-100"
                                                @click="ai.images = []"
                                            ></span>
                                    ...
                                    <div v-show="ai.images.length">
                                        <div class="grid grid-cols-4 gap-5">
                                            <div
                                                ...
                                                :class="{'!border-[#205132]': image.selected}"
                                    ...
                                    <div class="flex items-center gap-x-2.5">
                                        <template v-if="! ai.images.length">
                                            <button class="secondary-button">
                                                ...
                                                <template v-else>
                                                    <span class="icon-magic text-[#205132]"></span>
    ...
    <script type="text/x-template" id="v-media-image-item-template">
        <div class="group relative grid max-h-[120px] min-w-[120px] justify-items-center overflow-hidden rounded transition-all hover:border-gray-400">
            ...
            <div class="invisible absolute bottom-0 top-0 flex w-full flex-col justify-between bg-white p-3 opacity-80 transition-all group-hover:visible">
                <!-- Image Name -->
                ...
                <div class="flex justify-between">
                    <span
                        class="icon-delete cursor-pointer rounded-md p-1.5 text-2xl hover:bg-gray-200"
                        @click="remove"
                    ></span>

                    <label
                        class="icon-edit cursor-pointer rounded-md p-1.5 text-2xl hover:bg-gray-200"
