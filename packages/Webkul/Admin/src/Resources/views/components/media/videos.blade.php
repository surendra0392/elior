    ...
    >
        ...
        <div class="grid">
            <div class="flex gap-1">
                ...
                <label
                    class="grid h-[120px] max-h-[120px] w-full max-w-[210px] cursor-pointer items-center justify-items-center rounded border border-dashed transition-all hover:border-gray-400"
