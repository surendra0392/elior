...
@switch($type)
    ...
    @case('number')
        ...
        >
            <input
                ...
                {{ $attributes->except(['value', ':value', 'v-model', 'rules', ':rules', 'label', ':label'])->merge(['class' => 'w-full rounded-md border px-3 py-2.5 text-sm text-gray-600 transition-all hover:border-gray-400 focus:border-gray-400']) }}
            />
        </v-field>
    ...
    @case('color')
        ...
        >
            <input
                ...
                v-bind="field"
                {{ $attributes->except(['value'])->merge(['class' => 'w-full appearance-none rounded-md border text-sm text-gray-600 transition-all hover:border-gray-400']) }}
            >
        </v-field>
        @break
        ...
        >
            <x-admin::flat-picker.time>
                <input
                    ...
                    v-bind="field"
                    :class="[errors.length ? 'border !border-red-600 hover:border-red-600' : '']"
                    {{ $attributes->except(['value', ':value', 'v-model', 'rules', ':rules', 'label', ':label'])->merge(['class' => 'flex w-full min-h-[39px] py-2.5 px-3 border rounded-md text-sm text-gray-600 transition-all hover:border-gray-400 focus:border-gray-400']) }}
                    autocomplete="off"
                >
            </x-admin::flat-picker.time>
        </v-field>
    ...
    @case('multiselect')
        <v-field
            ...
            {{ $attributes->except([])->merge(['class' => 'flex w-full flex-col rounded-md border bg-white px-3 py-2.5 text-sm font-normal text-gray-600 transition-all hover:border-gray-400']) }}
            name="{{ $name }}"
            multiple
        >
            {{ $slot }}
        ...
        <label
             {{
                $attributes
                    ...
                    ->merge(['class' => 'icon-uncheckbox peer-checked:icon-checked text-2xl peer-checked:text-[#205132]'])
    ...
    @case('radio')
        ...
        <label
            class="icon-radio-normal peer-checked:icon-radio-selected cursor-pointer text-2xl peer-checked:text-[#205132]"
