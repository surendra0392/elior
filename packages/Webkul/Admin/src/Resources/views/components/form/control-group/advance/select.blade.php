...
@pushOnce('scripts')
    ...
    >
        <div class="relative w-full">
            ...
            >
                <div
                    class="flex min-h-[42px] w-full cursor-pointer items-center gap-1.5 rounded-md border bg-white px-3 py-1.5 text-sm transition-all hover:border-gray-400"
                    :class="[
                ...
                >
                    <span
                        ...
                        :class="selectedLabel ? 'text-gray-600' : 'text-gray-400'"
                    >
                        @{{ selectedLabel || placeholder }}
                    </span>

                    <span
                        class="icon-cross flex items-center text-lg text-gray-500 hover:text-red-600"
                        role="button"
                    ...
                    <span
                        class="icon-arrow-down flex items-center text-2xl text-gray-500 transition-transform"
