            ...
            <template v-else>
                ...
                >
                    <x-slot:toggle>
                        <div>
                            <div
                                class="relative inline-flex w-full max-w-max cursor-pointer select-none appearance-none items-center justify-between gap-x-1.5 rounded-[10px] border border-slate-200 bg-white px-3 py-2 text-center text-xs font-semibold text-slate-700 shadow-xs transition-all hover:border-slate-300 hover:bg-slate-50 focus:outline-none"
                                :class="{'border-[#205132] bg-[#205132]/5 !text-[#205132]': hasAnyAppliedColumn() }"
                            >
                                <span class="icon-filter text-base text-slate-500" :class="{'!text-[#205132]': hasAnyAppliedColumn()}"></span>
                                ...
                                <span
                                    class="h-2 w-2 rounded-full bg-[#205132] ring-2 ring-white"
                    ...
                    <x-slot:header>
                        ...
                        <div v-else class="flex items-center gap-x-2">
                            <span
                                class="icon-arrow-right rtl:icon-arrow-left mt-0.5 cursor-pointer text-3xl hover:rounded-md hover:bg-gray-100"
                                @click="backToFilters"
                            >
                            </span>
                        ...
                        <template v-if="! isShowSavedFilters">
                            ...
                            >
                                <x-slot:header class="px-4">
                                    <p class="w-full text-base font-semibold text-gray-800">
                                ...
                                <x-slot:content class="border-b !p-0">
                                    <div class="grid !p-0">
                                        ...
                                        <div v-for="(filter,index) in savedFilters.available">
                                            <div
                                                class="flex cursor-pointer items-center justify-between px-4 py-1.5 text-gray-700 hover:bg-gray-50"
                                                :class="{ 'bg-gray-50 font-semibold': applied.savedFilterId == filter.id }"
                                                @click="applySavedFilter(filter)"
                                            >
                                                <span class="text-xs font-medium text-gray-800">@{{ filter.name }}</span>

                                                <span
                                                    class="icon-cross rounded p-1.5 text-lg hover:bg-gray-200"
                            ...
                            <x-admin::accordion class="select-none !rounded-none !border-none !shadow-none">
                                <x-slot:header class="px-4">
                                    ...
                                    <div
                                        ...
                                        class="cursor-pointer text-xs font-medium leading-6 text-[#205132] transition-all hover:underline ltr:ml-20 rtl:mr-20"
                                            ...
                                            <div v-if="column.type === 'boolean'">
                                                ...
                                                <template v-if="column.filterable_type === 'dropdown'">
                                                    <div class="flex items-center justify-between">
                                                        ...
                                                        >
                                                            <p
                                                                class="cursor-pointer text-xs font-medium leading-6 text-[#205132]"
                                                    ...
                                                    <div class="mb-2 mt-1.5">
                                                        <x-admin::dropdown :fit-toggle="true">
                                                            <x-slot:toggle>
                                                                <button
                                                                    type="button"
                                                                    class="inline-flex w-full cursor-pointer appearance-none items-center justify-between gap-x-2 rounded-md border bg-white px-2.5 py-1.5 text-center leading-6 text-gray-600 transition-all marker:shadow hover:border-gray-400 focus:border-gray-400"
                                                                >
                                                            ...
                                                            <x-slot:menu class="!py-0">
                                                                ...
                                                                >
                                                                    <input
                                                                        ...
                                                                        class="w-full rounded-md border bg-white px-2.5 py-1.5 text-sm text-gray-600 transition-all focus:border-gray-400 focus:outline-none"
                                                                    >
                                                                </li>
                                                                ...
                                                                <div class="max-h-[240px] overflow-auto py-4">
                                                                    ...
                                                                    <li
                                                                        ...
                                                                        class="px-5 py-2 text-sm text-gray-400"
                                                                    >
                                            ...
                                            <div v-else-if="column.type === 'date'">
                                                ...
                                                <template v-if="column.filterable_type === 'date_range'">
                                                    ...
                                                    <div class="mt-1.5 grid grid-cols-2 gap-1.5">
                                                        <p
                                                            class="cursor-pointer rounded-md border px-3 py-2 text-center text-sm font-medium leading-6 text-gray-600 transition-all hover:border-gray-400"
                                            ...
                                            <div v-else>
                                                ...
                                                <template v-else>
                                                    ...
                                                    <div class="mb-2 mt-1.5 grid">
                                                        <input
                                                            type="text"
                                                            class="block w-full rounded-md border bg-white px-2 py-1.5 text-sm leading-6 text-gray-600 transition-all hover:border-gray-400 focus:border-gray-400"
                                                            :name="column.index"
                                                            :placeholder="column.label"
                                                            @change="addFilter($event, column)"
                                                        />
                                ...
                                >
                                    <form @submit="handleSubmit($event, createOrUpdateFilter)">
                                        <div class="flex flex-col gap-4">
                                            ...
                                            <div class="flex flex-col gap-2 border-b px-4">
