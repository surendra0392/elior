...
@pushOnce('scripts')
    ...
    >
        <div class="w-full">
            <div class="table-responsive box-shadow grid w-full overflow-x-auto rounded-[14px] border border-slate-200 bg-white shadow-sm overflow-hidden">
                <slot
                    name="header"
                    :is-loading="isLoading"
                    :available="available"
                        ...
                        >
                            ...
                            <p v-if="available.massActions.length">
                                <label for="mass_action_select_all_records">
                                    ...
                                    <span
                                        class="icon-uncheckbox cursor-pointer rounded-md text-2xl text-slate-400 hover:text-slate-600"
                                        :class="[
                                            applied.massActions.meta.mode === 'all' ? 'peer-checked:icon-checked !text-[#205132]' : (
                                                applied.massActions.meta.mode === 'partial' ? 'peer-checked:icon-checkbox-partial !text-[#205132]' : ''
                                            ),
                                        ]"
                                    >
                                    </span>
                            ...
                            <template v-for="column in available.columns">
                                <p
                                    class="flex items-center gap-1.5 break-words font-semibold text-slate-700"
                                    :class="{'cursor-pointer select-none hover:text-slate-900': column.sortable}"
                                    @click="sort(column)"
                                ...
                                >
                                    ...
                                    <i
                                        class="align-text-bottom text-base text-[#205132]"
                            ...
                            <!-- Actions -->
                            <p
                                class="place-self-end font-semibold text-slate-700"
                ...
                >
                    ...
                    <template v-else>
                            ...
                            >
                                ...
                                <p v-if="available.massActions.length">
                                    <label :for="`mass_action_select_record_${record[available.meta.primary_column]}`">
                                        ...
                                        <span class="icon-uncheckbox peer-checked:icon-checked cursor-pointer rounded-md text-2xl text-slate-400 peer-checked:!text-[#205132]">
                                        </span>
                                    </label>
                                </p>
                                ...
                                >
                                    <span
                                        class="cursor-pointer rounded-lg p-1.5 text-xl text-slate-500 hover:text-slate-900 transition-all hover:bg-slate-100 max-sm:place-self-center"
                                        :class="action.icon"
                        ...
                        <template v-else>
                            <div class="row grid min-h-[260px] place-content-center justify-items-center gap-3 border-b border-slate-100 px-4 py-8 text-center text-slate-600">
                                <img
                                    class="h-[120px] w-[120px] select-none p-2"
