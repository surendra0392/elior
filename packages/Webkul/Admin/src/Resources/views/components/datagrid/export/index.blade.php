<v-datagrid-export {{ $attributes }}>
    <div class="flex cursor-pointer items-center gap-1.5 rounded-[10px] border border-slate-200 bg-white px-3.5 py-2 text-xs font-semibold text-slate-700 shadow-xs hover:bg-slate-50 hover:text-slate-900 transition-all">
        <span class="icon-admin-export text-base text-slate-500"></span>
    ...
    >
        <div>
            <x-admin::modal ref="exportModal">
                <!-- Modal Toggler -->
                <x-slot:toggle>
                    <button class="flex cursor-pointer items-center gap-1.5 rounded-[10px] border border-slate-200 bg-white px-3.5 py-2 text-xs font-semibold text-slate-700 shadow-xs hover:bg-slate-50 hover:text-slate-900 transition-all">
                        <span class="icon-admin-export text-base text-slate-500"></span>
