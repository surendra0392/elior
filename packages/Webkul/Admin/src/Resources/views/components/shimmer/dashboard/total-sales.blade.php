...
<div class="grid w-full gap-4 border-b border-slate-200 px-4 py-2">
    <!-- Total Sales -->
    ...
    <div class="flex gap-1.5">
        ...
        <div class="grid w-full gap-1.5">
            <div class="flex aspect-[2] h-[180px] w-[285px] items-end border-b border-l border-slate-200 pl-2.5">
