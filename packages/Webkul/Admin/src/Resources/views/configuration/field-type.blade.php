    ...
    >
        <x-admin::form.control-group class="last:!mb-0">
            ...
            <template v-if="field.type == 'color' && field.is_visible">
                ...
                >
                    <input
                        ...
                        class="w-full appearance-none rounded-md border text-sm text-gray-600 transition-all hover:border-gray-400"
                    />
                </v-field>
            </template>
            ...
            <template v-if="field.type == 'select' && field.is_visible">
                ...
                >
                    <select
                        ...
                        class="custom-select w-full rounded-md border bg-white px-3 py-2.5 text-sm font-normal text-gray-600 transition-all hover:border-gray-400"
                    >
                        <option
            ...
            <template v-if="field.type == 'multiselect' && field.is_visible">
                ...
                >
                    <select
                        ...
                        v-bind="data.field"
                        v-model="data.value"
                        :class="['custom-select', 'w-full', 'rounded-md', 'border', 'bg-white', 'px-3', 'py-2.5', 'text-sm', 'font-normal', 'text-gray-600', 'transition-all', 'hover:border-gray-400', '', '', '', '', data.errors.length && 'border-red-500']"
                        multiple
                    >
                        <option
                            v-for="option in field.options"
            ...
            <template v-if="field.type == 'file' && field.is_visible">
                ...
                >
                    <div class="mb-1 inline-flex w-full max-w-max cursor-pointer appearance-none items-center justify-between gap-x-1 rounded-md border border-transparent p-1.5 text-center text-gray-600 transition-all marker:shadow hover:bg-gray-200 active:border-gray-300">
