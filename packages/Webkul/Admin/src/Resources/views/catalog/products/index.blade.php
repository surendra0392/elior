<x-admin::layouts>
    ...
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-0.5 text-xs text-slate-500">
                Manage your botanical powder catalog, pricing, inventory stock, and product attributes.
            </p>
        </div>
    ...
    >
            ...
            <template v-else>
                <div class="row datagrid-head datagrid-head-cards grid grid-cols-[2fr_1fr_1fr] grid-rows-1">
                    <div
                        ...
                        v-for="(columnGroup, index) in [['name', 'sku', 'attribute_family'], ['base_image', 'price', 'quantity', 'product_id'], ['status', 'featured', 'best_sellers', 'category_name', 'type']]"
                    >
                        @if ($hasPermission)
                            <label
                            ...
                            >
                                ...
                                <span
                                    ...
                                    :class="[
                                        applied.massActions.meta.mode === 'all' ? 'peer-checked:icon-checked peer-checked:text-[#205132]' : (
                                            applied.massActions.meta.mode === 'partial' ? 'peer-checked:icon-checkbox-partial peer-checked:text-[#205132]' : ''
                                        ),
                                    ]"
                                >
                                </span>
        ...
        <template #body="{
            ...
            <template v-else>
                <div
                    class="row border-b px-2 py-2.5 transition-all hover:bg-gray-50 sm:px-4 md:grid md:grid-cols-[2fr_1fr_1fr] md:grid-rows-1 md:gap-1.5"
                ...
                >
                        ...
                        <div class="flex items-start justify-between gap-3">
                            <div class="flex items-start gap-2.5">
                                ...
                                <div class="relative flex-shrink-0">
                                    ...
                                    <template v-else>
                                        <div class="relative h-12 w-12 rounded border border-dashed border-gray-300 sm:h-16 sm:w-16">
                                ...
                                <div class="flex flex-col gap-1 flex-1">
                                    <p class="break-all text-sm font-semibold text-gray-800 sm:text-base">
                                        @{{ record.name }}
                                    </p>
                                    ...
                                    <div class="flex items-center gap-2 mt-1">
                                        <v-product-attribute-toggle
                                            :product-id="record.product_id"
                                            attribute="best_sellers"
                                            :checked="record.best_sellers == 1"
                                            label="Best Seller"
                                        ></v-product-attribute-toggle>
                                    </div>
                                </div>
                            ...
                            <div class="flex items-center gap-1">
                                <span
                                    class="cursor-pointer rounded-md p-1.5 text-xl transition-all hover:bg-gray-200"
                                    :class="action.icon"
                    ...
                    <div class="hidden md:contents">
                        ...
                        <!-- Status, Featured, Best Sellers, Category, Type Columns -->
    ...
    @pushOnce('scripts')
        <script
            ...
            id="v-product-attribute-toggle-template"
        >
            <label class="relative inline-flex cursor-pointer items-center">
                <input
                    ...
                    :disabled="isLoading"
                >
                <div class="peer h-5 w-9 cursor-pointer rounded-full bg-slate-200 after:absolute after:top-0.5 after:h-4 after:w-4 after:rounded-full after:border after:border-slate-300 after:bg-white after:transition-all after:content-[''] peer-checked:bg-[#205132] peer-checked:after:border-white peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-[#205132]/20 after:ltr:left-0.5 peer-checked:after:ltr:translate-x-full after:rtl:right-0.5 peer-checked:after:rtl:-translate-x-full" :class="{'opacity-50': isLoading}"></div>
                <span class="ml-2 text-xs text-gray-600" v-text="label"></span>
            </label>
        </script>

        <script type="module">
            app.component('v-product-attribute-toggle', {
                template: '#v-product-attribute-toggle-template',

                props: ['productId', 'attribute', 'checked', 'label'],
                ...
                methods: {
                    toggle(event) {
                        ...
                        this.$axios.post('{{ route('admin.catalog.products.toggle_attribute') }}', {
                        ...
                        <x-admin::modal ref="productCreateModal">
                            ...
                            <x-slot:content>
                                ...
                                <div v-show="attributes.length">
                                    ...
                                    >
                                        <label
                                            class="block text-xs font-medium leading-6 text-gray-800"
                                            v-text="attribute.name"
                                        >
                                        </label>

                                        <div class="flex min-h-[38px] flex-wrap gap-1 rounded-md border p-1.5">
                                            <p
