...
@pushOnce('scripts')
    ...
    >
        <div class="box-shadow relative rounded bg-white">
            <!-- Panel Header -->
                        ...
                        <x-slot:content>
                            ...
                            >
                                ...
                                <v-field
                                    as="select"
                                    :name="attribute.code"
                                    class="custom-select flex min-h-[39px] w-full rounded-md border bg-white px-3 py-1.5 text-sm font-normal text-gray-600 transition-all hover:border-gray-400"
    ...
    >
        ...
        <div class="flex items-center gap-1.5 px-4">
            <span
                ...
                :class="{
                    '!icon-checked text-[#205132]': variants.length == selectedVariants.length,
                    '!icon-checkbox-partial text-[#205132]': selectedVariants.length && variants.length != selectedVariants.length
                }"
            ...
            <x-admin::dropdown v-bind:close-on-click="false">
                ...
                <x-slot:toggle>
                    <button
                        type="button"
                        class="flex cursor-pointer items-center rounded-md p-1.5 text-xs font-semibold text-[#205132] transition-all hover:bg-gray-100 focus:bg-gray-100"
                    >
                        @lang('admin::app.catalog.products.edit.types.configurable.mass-edit.select-variants')

                        <i class="icon-sort-down text-2xl text-[#205132]"></i>
                    </button>
                </x-slot>
                    ...
                    <template v-for="attribute in superAttributes">
                        ...
                        >
                            <div class="flex select-none">
                                ...
                                <label
                                    class="icon-uncheckbox peer-checked:icon-checked cursor-pointer text-2xl peer-checked:text-[#205132]"
                                    :for="'attribute_' + attribute.id + '_option_' + option.id"
                                >
                                </label>
                            </div>
                                            ...
                                            <div class="mb-2.5 grid grid-cols-3 gap-4">
                                                ...
                                                >
                                                    ...
                                                    <v-field
                                                        ...
                                                        value="0"
                                                        class="flex min-h-[39px] w-full rounded-md border bg-white px-3 py-1.5 text-sm font-normal text-gray-600 transition-all hover:border-gray-400"
                                ...
                                <template v-if="selectedType == 'editPrices'">
                                    <x-admin::form.control-group class="mb-0 max-w-[115px] flex-1">
                                        <div class="relative">
                                            ...
                                            <v-field
                                                type="text"
                                                class="flex min-h-[39px] w-full rounded-md border bg-white py-1.5 text-sm font-normal text-gray-600 transition-all hover:border-gray-400 ltr:pl-8 rtl:pr-8"
                                ...
                                <template v-if="selectedType == 'editWeight'">
                                    <x-admin::form.control-group class="mb-0 max-w-[115px] flex-1">
                                        <div class="relative">
                                            <v-field
                                                type="text"
                                                class="flex min-h-[39px] w-full rounded-md border bg-white py-1.5 text-sm font-normal text-gray-600 transition-all hover:border-gray-400 ltr:pl-2.5 rtl:pr-2.5"
                                                :class="[errors['variants[variant_' + variant.id + ']'] ? 'border border-red-500' : '']"
                                                :name="'variants[variant_' + variant.id + ']'"
                                                ::rules="{ required: true, regex: /^([0-9]*[1-9][0-9]*(\.[0-9]+)?|[0]+\.[0-9]*[1-9][0-9]*)$/ }"
                                    ...
                                    <x-slot:content>
                                        ...
                                        >
                                            ...
                                            <a
                                                ...
                                                class="inline-block text-[#205132] hover:text-[#205132] hover:underline"
                                                target="_blank"
                                            >
