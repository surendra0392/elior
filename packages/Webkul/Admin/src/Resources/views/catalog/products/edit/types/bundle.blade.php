        ...
        <div>
            ...
            <div class="mb-2.5 flex justify-between gap-5 p-4">
                ...
                <div class="flex items-center gap-x-5">
                    <p
                        class="cursor-pointer font-semibold text-[#205132] transition-all hover:underline"
            ...
            >
                ...
                >
                    <template #item="{ element, index }">
                        <div class="flex justify-between gap-2.5 border-b border-slate-300 p-4">
                            <!-- Information -->
                            <div class="flex gap-2.5">
                                <!-- Drag Icon -->
                                <div>
                                    <i class="icon-drag cursor-grab text-xl transition-all hover:text-gray-700"></i>
                                </div>
                                ...
                                <div>
                                    ...
                                    <label
                                        class="cursor-pointer text-2xl peer-checked:text-[#205132]"
                                ...
                                <div
                                    ...
                                    :class="{'overflow-hidden rounded border border-dashed border-gray-300': ! element.product.images.length}"
                                >
                            ...
                            <div class="grid place-content-start gap-1 ltr:text-right rtl:text-left">
                                ...
                                <x-admin::form.control-group class="!mb-0">
                                    ...
                                    <v-field
                                        ...
                                        v-model="element.qty"
                                        class="min-h-[39px] w-[86px] rounded-md border px-3 py-2 text-sm text-gray-600 transition-all hover:border-gray-400"
