                    ...
                    <template #item="{ element, index }">
                        <div class="flex justify-between gap-2.5 border-b border-slate-300 p-4">
                            ...
                            <div class="flex gap-2.5">
                                <!-- Drag Icon -->
                                <i class="icon-drag cursor-grab text-xl text-gray-600 transition-all"></i>
                                        ...
                                        <template v-if="element.type == 'file'">
                                            <div>
                                                ...
                                                <a
                                                    ...
                                                    target="_blank"
                                                    class="break-all text-[#205132] transition-all hover:underline"
                                                >
                                                    @{{ element.file_name }}
                                                </a>
                                            </div>
                                ...
                                <div class="flex gap-4">
                                    ...
                                    <template v-if="selectedLink.type == 'file'">
                                        <x-admin::form.control-group class="flex-1">
                                            ...
                                            <input
                                                type="file"
                                                class="flex min-h-[39px] w-full rounded-md border px-3 py-1 text-sm text-gray-600 transition-all hover:border-gray-400"
                                            ...
                                            <a
                                                ...
                                                class="break-all text-sm text-[#205132] transition-all hover:underline"
                                                target="_blank"
