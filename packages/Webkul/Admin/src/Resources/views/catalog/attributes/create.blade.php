                                ...
                                <x-admin::table>
                                    ...
                                    >
                                        <template #item="{ element, index }">
                                            <x-admin::table.thead.tr class="hover:bg-gray-50">
                                                <!-- Draggable Icon -->
                                                ...
                                                <x-admin::table.td class="!px-0">
                                                    ...
                                                    <span
                                                        class="icon-delete cursor-pointer rounded-md p-1.5 text-2xl transition-all hover:bg-gray-200 max-sm:place-self-center"
