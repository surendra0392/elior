                            ...
                            <template #item="{ element, index }">
                                <div class="">
                                    ...
                                    <div class="group flex items-center">
                                        ...
                                        <!-- Group Name -->
                                        <div
                                            class="group_node group flex max-w-max gap-1.5 rounded py-1.5 text-gray-600 transition-all ltr:pr-1.5 rtl:pl-1.5"
                        ...
                        >
                            <template #item="{ element }">
                                <div class="group flex max-w-max gap-1.5 rounded py-1.5 text-gray-600 ltr:pr-1.5 rtl:pl-1.5">
                                    ...
                                    <i class="icon-attribute text-xl transition-all group-hover:text-gray-800"></i>
