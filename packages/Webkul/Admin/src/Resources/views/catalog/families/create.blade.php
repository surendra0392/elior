<x-admin::layouts>
    ...
    <x-admin::form :action="route('admin.catalog.families.store')">
        ...
        <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
            <!-- Left Container -->
            <div class="box-shadow flex flex-1 flex-col gap-2 rounded bg-white max-xl:flex-auto">
                <v-family-attributes>
                ...
                <div class="flex [&>*]:flex-1 gap-5 justify-between px-4">
                    ...
                    <div v-for="(groups, column) in columnGroups">
                        ...
                        <div class="mb-4 flex flex-col">
                            <p class="font-semibold leading-6 text-gray-600">
                                @{{
                                    column == 1
                            ...
                            <template #item="{ element, index }">
                                <div class="">
                                    ...
                                    <div class="group flex items-center">
                                        <!-- Toggle -->
                                        <i
                                            class="icon-sort-down cursor-pointer rounded-md text-xl transition-all hover:bg-gray-100 group-hover:text-gray-800"
                                        ...
                                        <!-- Group Name -->
                                        <div
                                            class="group_node group flex max-w-max cursor-pointer gap-1.5 rounded py-1.5 text-gray-600 transition-all group-hover:text-gray-800 ltr:pr-1.5 rtl:pl-1.5"
                                            :class="{'bg-[#205132] text-white group-hover:[&>*]:text-white': selectedGroup.id == element.id}"
                                            @click.stop="groupSelected(element)"
                                        >
                                            <i class="icon-drag cursor-grab text-xl text-inherit transition-all group-hover:text-gray-800"></i>
                                            ...
                                            <span
                                                class="font-regular text-sm text-inherit transition-all group-hover:text-gray-800"
                                            ...
                                            <input
                                                ...
                                                class="group_node text-sm !text-gray-600"
                                    ...
                                    >
                                        <template #item="{ element, index }">
                                            <div class="group flex max-w-max gap-1.5 rounded py-1.5 text-gray-600 ltr:pr-1.5 rtl:pl-1.5">
                                                <i class="icon-drag cursor-grab text-xl transition-all group-hover:text-gray-800"></i>

                                                <i
                                                    class="text-xl transition-all group-hover:text-gray-800"
                                                    :class="[element.is_user_defined ? 'icon-attribute' : 'icon-attribute-block']"
                                                >
                                                </i>
                                                

                                                <span class="font-regular text-sm transition-all group-hover:text-gray-800 max-xl:text-xs">
                                                    @{{ element.admin_name }}
                                                </span>
                        ...
                        >
                            <template #item="{ element }">
                                <div class="group flex max-w-max gap-1.5 rounded py-1.5 text-gray-600 ltr:pr-1.5 rtl:pl-1.5">
                                    ...
                                    <i class="text-xl transition-all group-hover:text-gray-800"></i>
