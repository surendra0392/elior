                    ...
                    <div class="box-shadow rounded bg-white p-4">
                        ...
                        <x-admin::form.control-group>
                            ...
                            <template v-if="haveStates()">
                                <x-admin::form.control-group.label class="flex justify-between items-center w-full">
                                    <span>@lang('admin::app.settings.taxes.rates.create.state')</span>
                                    <div class="flex gap-2">
                                        <a href="#" @click.prevent="selectAllStates" class="text-[#205132] hover:underline text-xs cursor-pointer">Select All</a>
                                        <a href="#" @click.prevent="deselectAllStates" class="text-[#205132] hover:underline text-xs cursor-pointer">Deselect All</a>
                                    </div>
                                </x-admin::form.control-group.label>
                                ...
                                >
                                    <option value="">
                                        ...
                                        <option
                                            v-for='(stateObj, index) in countryStates[country]'
                                            :value="stateObj.code"
                                            :selected="state.includes(stateObj.code)"
                                        >
            ...
            app.component('v-create-taxrate', {
                ...
                methods: {
                    ...
                    selectAllStates: function () {
                        if (this.haveStates()) {
                            this.state = this.countryStates[this.country].map(s => s.code);
                            
                            this.$nextTick(() => {
                                let select = this.$el.querySelector('select[name="state[]"]');
                                if (select) {
