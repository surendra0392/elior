<x-admin::layouts>
    ...
    <x-admin::form :action="route('admin.settings.shipping.zones.store')">
                    ...
                    <div class="flex flex-col gap-4 max-xl:w-full flex-1">
                        ...
                        <div class="box-shadow rounded bg-white p-4">
                            ...
                            <x-admin::form.control-group>
                                ...
                                <x-admin::form.control-group.control type="text" name="name" rules="required" :label="'Zone Name'" />
                                <x-admin::form.control-group.error control-name="name" />
                            </x-admin::form.control-group>
                            
                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label>Status</x-admin-form.control-group.label>
                                <x-admin::form.control-group.control type="switch" name="is_active" value="1" :label="'Status'" :checked="true" />
                        ...
                        <div class="box-shadow rounded bg-white p-4">
                            ...
                            <div v-for="(location, index) in locations" :key="index" class="flex gap-4 items-start mb-4 bg-gray-50 p-4 rounded border border-gray-200">
                                <div class="w-1/3">
