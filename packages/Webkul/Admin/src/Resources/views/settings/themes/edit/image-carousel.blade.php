    ...
    >
        <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
            <div class="box-shadow rounded bg-white p-4">
                ...
                >
                    <!-- Hidden File Input for New/Updated Images -->
                    <input
                        type="file"
                        class="hidden"
                        :name="image.is_new ? '{{ $currentLocale->code }}[options]['+ index +'][image]' : ''"
                    ...
                    <div 
                        ...
                        :class="{
                            'border-b border-slate-300': index < sliders.images.length - 1
                        }"
                    >
                                ...
                                <p class="text-gray-600">
                                    ...
                                    <span class="text-gray-600 transition-all">
                                        <a
                                            ...
                                            :ref="'image_' + index"
                                            target="_blank"
                                            class="text-[#205132] transition-all hover:underline ltr:ml-2 rtl:mr-2"
                                        >
