            ...
            <div class="box-shadow rounded bg-white p-4">
                ...
                <x-admin::form.control-group>
                    ...
                    >
                        <select
                            ...
                            v-bind="field"
                            class="custom-select flex min-h-[39px] w-full rounded-md border border-gray-300 bg-white px-3 py-1.5 text-sm font-normal text-gray-600 transition-all hover:border-gray-400"
                ...
                >
                    ...
                    <div 
                        ...
                        :class="{
                            'border-b border-slate-300': index < options.filters.length - 1
                        }"
                    >
