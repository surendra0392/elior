    ...
    @pushOnce('scripts')
        ...
        >
            <div class="mt-3.5 flex flex-col gap-2.5">
                        ...
                        <template v-for="(step, index) in steps">
                            ...
                            <li class="relative flex shrink-0 flex-col items-center">
                                ...
                                <span
                                    ...
                                    :class="index <= currentStep ? 'text-gray-800' : 'text-gray-400'"
                                >
                                    @{{ step }}
                                </span>
                            </li>
                ...
                <!-- Phase Panel -->
                <div class="box-shadow grid gap-2.5 rounded bg-white p-4">
                    <!-- Ready To Validate -->
                    <div
                    ...
                    <!-- Validating -->
                    <div
                        class="grid w-full gap-2 rounded-sm border border-[#205132]/20 bg-[#205132]/10 p-3"
                        v-else-if="importResource.state == 'validating'"
                    >
                        <p class="flex items-center gap-2">
                            <i class="icon-information rounded-full bg-[#205132]/20 text-2xl text-[#205132]"></i>

                            @lang('admin::app.settings.data-transfer.imports.import.validating-info')
                        </p>

                        <div class="h-5 w-full rounded-sm bg-[#205132]/20">
                            <div
                                class="h-5 rounded-sm bg-[#205132] transition-all duration-300"
                    ...
                    >
                        ...
                        <div class="grid gap-2">
                            ...
                            <p
                                ...
                                v-else-if="isValid"
                            >
                                <i class="icon-information h-fit rounded-full bg-orange-200 text-2xl text-orange-600"></i>
                    ...
                    >
                        ...
                        <div class="h-5 w-full rounded-sm bg-green-200">
                            <div
                    ...
                    >
                        ...
                        <div class="grid gap-2">
                            ...
                            <p
                                class="mb-2 flex items-center gap-2 text-base text-orange-700"
                                v-if="stats.batches?.failed"
                            >
                                <i class="icon-error h-fit rounded-full bg-orange-200 text-2xl text-orange-600"></i>
            ...
            app.component('v-import', {
                ...
                methods: {
                    ...
                    stepNodeClass(index) {
                        ...
                        if (index === this.currentStep) {
                            return 'border-[#205132] text-[#205132]';
                        }
