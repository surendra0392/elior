        ...
        <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-0.5 text-xs text-slate-500">
                    Manage administrative team members, access roles, and permissions.
                </p>
            </div>
            ...
            >
                ...
                <template #header="{
                    ...
                    >
                            ...
                            <p class="text-xs font-bold uppercase tracking-wider text-slate-500">
                                <span class="[&>*]:after:content-['_/_']">
                                    <span
                                        ...
                                        :class="{
                                            'text-[#205132] font-bold': applied.sort.column == columnGroup,
                                            'cursor-pointer hover:text-slate-900': available.columns.find(columnTemp => columnTemp.index === columnGroup)?.sortable,
                                        }"
                                        @click="
                        ...
                        <!-- Actions -->
                        @if ($hasPermission)
                            <p class="flex justify-end gap-2.5 text-xs font-bold uppercase tracking-wider text-slate-500">
                ...
                <template #body="{
                    ...
                    <template v-else>
                        <div
                            ...
                            class="row datagrid-card grid items-center gap-2.5 border-b px-4 py-4 text-gray-600 transition-all hover:bg-gray-50"
                            style="grid-template-columns: repeat({{ $hasPermission ? '6' : '5' }}, minmax(150px, 1fr));"
                        >
                            <!-- ID -->
                            ...
                            <p data-label="@lang('admin::app.settings.users.index.datagrid.name')">
                                <div class="flex items-center gap-2.5">
                                    ...
                                    <div
                                        ...
                                        v-else
                                    >
                                        <button class="flex h-9 w-9 cursor-pointer items-center justify-center rounded-full bg-[#205132] text-sm font-semibold leading-6 text-white transition-all hover:bg-[#1b432a] focus:bg-[#163823] shadow-sm">
                            ...
                            <div class="flex gap-4">
                                ...
                                <x-admin::form.control-group class="w-full flex-1">
                                    ...
                                    >
                                        <select
                                            name="role_id"
                                            class="flex min-h-[39px] w-full rounded-md border bg-white px-3 py-2 text-sm text-gray-600 transition-all hover:border-gray-400 focus:border-gray-400"
