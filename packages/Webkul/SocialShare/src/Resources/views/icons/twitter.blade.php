<svg class="w-7 h-7 sm:w-[30px] sm:h-[30px] rounded-full shadow-sm hover:scale-110 hover:-translate-y-0.5 transition-all duration-200" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
